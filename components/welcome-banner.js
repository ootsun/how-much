...
export default function WelcomeBanner() {
    ...
    return (
        <div className={`${show ? '' : 'hidden'} welcome-banner-wrapper bg-white shadow-xl w-max max-w-full absolute z-10 bottom-10 left-1/2 -translate-x-1/2 px-2 py-3 rounded-lg border dark:bg-gray-800`}>
